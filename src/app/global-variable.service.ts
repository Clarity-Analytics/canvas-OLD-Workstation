...
export class GlobalVariableService {
    ...
    dirtyDataDashboardGroupRelationship = new BehaviorSubject(true);
    dirtyDataDashboard = new BehaviorSubject(true);
    dirtyDataDashboardsPerUser = new BehaviorSubject(true);
    dirtyDataDashboardUserRelationship = new BehaviorSubject(true);
    dirtyDataDatasource = new BehaviorSubject(true);
    ...
    dirtyDataGroupDatasourceAccess = new BehaviorSubject(true);
    dirtyDataNotification = new BehaviorSubject(true);
    dirtyDataPackageTask = new BehaviorSubject(true);
    dirtyDataPersonalisation = new BehaviorSubject(true);
    ...
    dirtyDataBorderDropdown = new BehaviorSubject(true);
    dirtyDataBoxShadowDropdown = new BehaviorSubject(true);
    ...
    dirtyDataTextAlignDropdown = new BehaviorSubject(true);
    dirtyDataImageSourceDropdown = new BehaviorSubject(true);
